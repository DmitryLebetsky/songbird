...
// Folk
import folkIcon from '../assets/images/icons/genres-icons/folk-icon.jpg';

import joeyBateyTossACoinToYourWitcherCover from '../assets/images/songs/folk/joey-batey-toss-a-coin-to-your-witcher.jpg';
import joeyBateyTossACoinToYourWitcherAudio from '../assets/songs/folk/Joey Batey - Toss A Coin To Your Witcher.mp3';
import joeyBateyTossACoinToYourWitcherAudioMinus from '../assets/songs/folkMinuses/Joey Batey - Toss A Coin To Your Witcher (minus).mp3';

import simonAndGarfunkelSoundOfSilenceCover from '../assets/images/songs/folk/simon-and-garfunkel-soung-of-silence.jpg';
import simonAndGarfunkelSoundOfSilenceAudio from '../assets/songs/folk/Simon & Garfunkel - Sound of Silence.mp3';
import simonAndGarfunkelSoundOfSilenceAudioMinus from '../assets/songs/folkMinuses/Simon & Garfunkel - Sound of Silence (minus).mp3';

import edSheeranThePartingGlassCover from '../assets/images/songs/folk/ed-sheeran-the-parting-glass.jpg';
import edSheeranThePartingGlassAudio from '../assets/songs/folk/Ed Sheeran - The Parting Glass.mp3';
import edSheeranThePartingGlassAudioMinus from '../assets/songs/folkMinuses/Ed Sheeran - The Parting Glass (minus).mp3';

import americaYouCanDoMagicCover from '../assets/images/songs/folk/america-you-can-do-magic.jpg';
import americaYouCanDoMagicAudio from '../assets/songs/folk/America - You Can Do Magic.mp3';
import americaYouCanDoMagicAudioMinus from '../assets/songs/folkMinuses/America - You Can Do Magic (minus).mp3';

import ofMonstersAndMenLittleTalksCover from '../assets/images/songs/folk/of-monsters-and-men-little-talks.jpg';
import ofMonstersAndMenLittleTalksAudio from '../assets/songs/folk/Of Monsters And Men - Little Talks.mp3';
import ofMonstersAndMenLittleTalksAudioMinus from '../assets/songs/folkMinuses/Of Monsters And Men - Little Talks (minus).mp3';

import simonGarfunkelOldFriendsBookendsCover from '../assets/images/songs/folk/simon-and-garfunkel-old-friends-bookends.jpg';
import simonGarfunkelOldFriendsBookendsAudio from '../assets/songs/folk/Simon & Garfunkel - Old Friends Bookends.mp3';
import simonGarfunkelOldFriendsBookendsAudioMinus from '../assets/songs/folkMinuses/Simon & Garfunkel - Old Friends Bookends (minus).mp3';

// R&B
import rAndBIcon from '../assets/images/icons/genres-icons/R&B-icon.jpg';

import rayCharlesHitTheRoadJackCover from '../assets/images/songs/R&B/ray-charles-hit-the-road-jack.png';
import rayCharlesHitTheRoadJackAudio from '../assets/songs/R&B/Ray Charles - Hit The Road Jack.mp3';
import rayCharlesHitTheRoadJackAudioMinus from '../assets/songs/R&BMinuses/Ray Charles - Hit The Road Jack (minus).mp3';

import arianaGrandeFocusCover from '../assets/images/songs/R&B/ariana-grande-focus.jpg';
import arianaGrandeFocusAudio from '../assets/songs/R&B/Ariana Grande - Focus.mp3';
import arianaGrandeFocusAudioMinus from '../assets/songs/R&BMinuses/Ariana Grande - Focus (minus).mp3';

import demiLovatoSoberCover from '../assets/images/songs/R&B/demi-lovato-sober.jpg';
import demiLovatoSoberAudio from '../assets/songs/R&B/Demi Lovato - Sober.mp3';
import demiLovatoSoberAudioMinus from '../assets/songs/R&BMinuses/Demi Lovato - Sober (minus).mp3';

import lilPeepXXXTENTACIONFallingDownCover from '../assets/images/songs/R&B/lil-peep-and-xxxtentacion-falling-down.jpg';
import lilPeepXXXTENTACIONFallingDownAudio from '../assets/songs/R&B/Lil Peep & XXXTENTACION - Falling Down.mp3';
import lilPeepXXXTENTACIONFallingDownAudioMinus from '../assets/songs/R&BMinuses/Lil Peep & XXXTENTACION - Falling Down (minus).mp3';

import flyboyTarantinoAndCraigXenAndKidwayNowOrNeverCover from '../assets/images/songs/R&B/flyboy-tarantino-and-craig-xen-and-kidway-no-or-never.jpg';
import flyboyTarantinoAndCraigXenAndKidwayNowOrNeverAudio from '../assets/songs/R&B/Flyboy Tarantino, Craig Xen & Kidway - Now Or Never.mp3';
import flyboyTarantinoAndCraigXenAndKidwayNowOrNeverAudioMinus from '../assets/songs/R&BMinuses/Flyboy Tarantino, Craig Xen & Kidway - Now Or Never (minus).mp3';

import laurenDaigleThisGirlCover from '../assets/images/songs/R&B/lauren-daigle-this-girl.jpg';
import laurenDaigleThisGirlAudio from '../assets/songs/R&B/Lauren Daigle - This Girl.mp3';
import laurenDaigleThisGirlAudioMinus from '../assets/songs/R&BMinuses/Lauren Daigle - This Girl (minus).mp3';

// Country
import countryIcon from '../assets/images/icons/genres-icons/country-icon.jpg';

import johnnyCashHurtCover from '../assets/images/songs/country/johny-cash-hurt.jpg';
import johnnyCashHurtAudio from '../assets/songs/country/Johnny Cash - Hurt.mp3';
import johnnyCashHurtAudioMinus from '../assets/songs/countryMinuses/Johnny Cash - Hurt (minus).mp3';

import mileyCyrusNothingBreaksLikeAHeartCover from '../assets/images/songs/country/miley-cyrus-nothing-breaks-like-a-heart.jpg';
import mileyCyrusNothingBreaksLikeAHeartAudio from '../assets/songs/country/Mark Ronson - Nothing Breaks Like a Heart.mp3';
import mileyCyrusNothingBreaksLikeAHeartAudioMinus from '../assets/songs/countryMinuses/Miley Cyrus - Nothing Breaks Like A Heart (minus).mp3';

import beyonceDaddyLessonsCover from '../assets/images/songs/country/beyonce-daddy-lessons.png';
import beyonceDaddyLessonsAudio from '../assets/songs/country/Beyoncé - Daddy Lessons.mp3';
import beyonceDaddyLessonsAudioMinus from '../assets/songs/countryMinuses/Beyoncé - Daddy Lessons (minus).mp3';

import theBandPerryIfIDieYoungCover from '../assets/images/songs/country/the-bend-perry-if-i-die-young.jpg';
import theBandPerryIfIDieYoungAudio from '../assets/songs/country/The Band Perry - If I Die Young.mp3';
import theBandPerryIfIDieYoungAudioMinus from '../assets/songs/countryMinuses/The Band Perry - If I Die Young (minus).mp3';

import taylorSwiftHauntedCover from '../assets/images/songs/country/taylor-swift-haunted.jpg';
import taylorSwiftHauntedAudio from '../assets/songs/country/Taylor Swift - Haunted.mp3';
import taylorSwiftHauntedAudioMinus from '../assets/songs/countryMinuses/Taylor Swift - Haunted (minus).mp3';

import rodneyAtkinsIfYoureGoingThroughHellCover from '../assets/images/songs/country/rodney-atkins-if-youre-going-through-hell.jpg';
    ...
    songs: [
      {
        ...
        audio: joeyBateyTossACoinToYourWitcherAudio,
      ...
      },
      {
        ...
        audio: simonAndGarfunkelSoundOfSilenceAudio,
      ...
      },
      {
        ...
        audio: edSheeranThePartingGlassAudio,
      ...
      },
      {
        ...
        audio: americaYouCanDoMagicAudio,
      ...
      },
      {
        ...
        audio: ofMonstersAndMenLittleTalksAudio,
      ...
      },
      {
        ...
        audio: simonGarfunkelOldFriendsBookendsAudio,
        audioMinus: simonGarfunkelOldFriendsBookendsAudioMinus,
      },
    ],
  },
  {
    ...
    songs: [
      {
        ...
        audio: rayCharlesHitTheRoadJackAudio,
      ...
      },
      {
        ...
        audio: lilPeepXXXTENTACIONFallingDownAudio,
      ...
      },
      {
        ...
        audio: flyboyTarantinoAndCraigXenAndKidwayNowOrNeverAudio,
      ...
      },
      {
        ...
        audio: laurenDaigleThisGirlAudio,
        audioMinus: laurenDaigleThisGirlAudioMinus,
      },
    ],
  },
  {
    ...
    songs: [
      ...
      },
      {
        ...
        audio: mileyCyrusNothingBreaksLikeAHeartAudio,
      ...
      },
      {
        ...
        audio: beyonceDaddyLessonsAudio,
      ...
      },
      {
        ...
        audio: theBandPerryIfIDieYoungAudio,
      ...
      },
      {
        ...
        audio: rodneyAtkinsIfYoureGoingThroughHellAudio,
        audioMinus: rodneyAtkinsIfYoureGoingThroughHellAudioMinus,
      },
    ],
  },
  {
